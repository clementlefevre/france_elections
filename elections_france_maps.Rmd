...
df<-data.frame()
candidate_colors <- with(df, data.frame(best_candidate = levels(comm2@data$best_candidate), color = palette <- brewer.pal(n = 9, name = "Set1")))
...
plot(comm2,col = candidates_palette$color)
