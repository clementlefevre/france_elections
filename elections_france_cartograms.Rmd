...
# plot it
tm_shape(dept_cartogram) + tm_fill("LE.PEN_ratio_voix", style="quantile",palette="Blues") + 
  tm_borders() + tm_layout(frame=F)

# plot it
tm_shape(dept_cartogram) + tm_fill("MACRON_ratio_voix", style="quantile",palette="Blues") + 
  tm_borders() + tm_layout(frame=F)
